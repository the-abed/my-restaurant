            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                ...
                <div className="space-y-6">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                        Experience the authentic taste of {food.area} cuisine with our signature {food.title}. 
                        Prepared with fresh ingredients and traditional spices to bring you a 
